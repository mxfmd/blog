...
# Change ownership of tomcat directories to appuser
RUN chown -R appuser:appuser /usr/local/tomcat/webapps/ \
    && chown -R appuser:appuser /usr/local/tomcat/logs/ \
    && chown -R appuser:appuser /usr/local/tomcat/temp/ \
    && chown -R appuser:appuser /usr/local/tomcat/work/
